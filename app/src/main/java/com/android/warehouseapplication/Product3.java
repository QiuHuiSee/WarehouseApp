...
public class Product3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent BackIntent = new Intent(Product3.this, Page1.class);
    ...
    public class fetchData1 extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            image.setImageResource(R.drawable.sweateruniqlo);

            pro1_id.setText("Product ID: "+ID.get(2));
            description.setText("Product Description: "+Description.get(2));
            brand.setText("Product Brand: "+Brand.get(2));
            cost.setText("Product Cost per Unit (RM): "+Cost.get(2));
            manufacturer.setText("Product Manufacturer: "+Manufacturer.get(2));
        }
    }
}
