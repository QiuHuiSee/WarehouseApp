...
public class Product2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent BackIntent = new Intent(Product2.this, Page1.class);
    ...
    public class fetchData1 extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            image.setImageResource(R.drawable.lvbag);

            pro1_id.setText("Product ID: "+ID.get(1));
            description.setText("Product Description: "+Description.get(1));
            brand.setText("Product Brand: "+Brand.get(1));
            cost.setText("Product Cost per Unit (RM): "+Cost.get(1));
            manufacturer.setText("Product Manufacturer: "+Manufacturer.get(1));
